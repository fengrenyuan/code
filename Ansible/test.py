...
#测试
ansible_test = MyAnsiable2(inventory='/Users/liuzengyi/Desktop/code/Ansible/hosts')
ansible_test.run('localhost','no','shell','ls')
ansible_test.playbook(['./test.yml'])
ansible_test.get_result()